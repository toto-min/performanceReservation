...
<head>
    ...
    <script type="text/javascript">
      ...
      function submit(){
    	 form.action="${path}/qna/Qnareply.do?parentno=${parentno}"
    	 form.method="get"
    	 form.submit();
     } 
               ...
               <table id="mainqna">
                   ...
                   <tr>
                       ...
                       <td rowspan="8" id="qnamain">
                           ...
                           <form action="${path}/qna/Qnareply.do" id="qnaconts" method="post" name="form">
                           <input type="hidden" value="${parentno}" name="parentno">
                                ...
                                <!--    <tr id="anseralam">
                                       ...
                                       <td>
                                           <div class="mail">
                                               ...
                                               <label for="anserEmail">이메일로 답글 알리기</label>
                               ...
                               <div class="finbtn">
                                    ...
                                    <label for="success" id="sucbtn" >답글 반영하기</label>
